...
function showBlogs(data) {
	...
	for (let i = 0; i < data.count; i++) {
		var myhtml = '<a href="/admin/resources/blog/' + data.blog_data[i]._id + '">';
		myhtml += '<div class="d-flex flex-row flex-nowrap"> <div className="user_name align-self-end"> <div class="card1"> <img class="card-img-top imgStyle" src="/admin/Image/' + data.blog_data[i].Filename + '"alt="Card image cap" />';
		...
		myhtml += '<p class="card-text"><small class="text-muted">' + data.blog_data[i].CreatedDate + '.toDateString() </small> </p>';
